...
f_zobj_set(_g,"f_zobj,@,f_zobj_set,@,f_zobj_eval,@,f_zcall,@,f_refresh_top,@,f_add_to_ui_stack,@,f_pop_ui_stack,@,f_getsel,@,f_setsel,@,f_create_gridpair,@,f_update_grid,@,f_draw_grid,@,f_addop_text,@,f_minisfx,@,f_flr_rnd,@,f_in_split,@,f_roundrect,@,f_draw_pkmn,@,f_change_pp,@,f_moveutil_damage,@,f_move_splash,@,f_move_damage,@,f_move_seismictoss,@,f_move_psywave,@,f_move_superfang,@,f_move_falseswipe,@,f_move_submission,@,f_move_heal,@,c_move_funcs,@,c_move_names,@,c_trnr_names,@,c_type_names,@,c_item_names,@,c_pkmn_names,@,c_gender_names,@,c_major_names_long,@,c_major_names_short,@,c_movemethod_names,@,c_statmod_names,@,c_palettes,@,c_palette_names,@,c_types,@,f_init_peek_inc,@,f_unlock,@,f_update_locks,@,f_create_spot,@,f_get_edit_op_pkmn,@,f_op_template_edit,@,f_add_stat_move,@,f_add_stat_info,@,f_add_stat,@,f_print_top,@,f_print_bot,@,f_get_move_texts,@,f_prefix_space,@,f_prefix_zero,@,f_dt_browse_template,@,f_add_battle,@,f_create_active,@,f_create_player,@,f_get_other_pl,@,f_set_pself,@,f_get_live_pkmn,@,f_get_next_active,@,f_end_battle,@,f_newaction,@,f_addaction,@,f_pkmn_comes_out,@,f_pop_next_action,@,f_postmove_logic,@,f_set_player_priority,@,f_movelogic,@,f_turn_end_p2,@,f_turn_end_p1,@,f_calc_movemod,@,f_get_type_advantage,@,f_calc_move_damage,@,f_mkpkmn,@,f_team_party,@,f_fill_team,@,f_team_league,@,f_get_party_pkmn,@,f_save_party_pkmn,@,f_stat_crit,@,f_stat_evac,@,f_stat_calc,@,f_op_def,@,f_op_edititem,@,f_op_statbrowse,@,f_op_browse,@,f_op_statbattle,@,f_op_edit,@,f_op_editteam,@,f_op_title,@,f_op_prevpk,@,f_op_teams,@,f_op_editmovebot,@,f_op_editstat,@,f_op_editmove,@,f_op_batsel,@",f_zobj,f_zobj_set,f_zobj_eval,function(func,text,...)
...
f_zobj("sel,0,view,0,name,@,selfunc,@,leavefunc,@,lrbasegrid,@,w,@,vh,@,x,@,y,@,cw,@,ch,@,selh,@",name,main_sel_func,main_leave_func,lrbasegrid,unpack(main_grid_spec)),
f_zobj("sel,-1,view,-1,name,@,df,@,w,@,vh,@,x,@,y,@,cw,@,ch,@,selh,@",name,info_grid_draw,unpack(info_grid_spec)),
main_op_func,
{...}
)
...
if hp>0 then
rectfill(x+1,y+2,x+1+mid(0,hp/maxhp*32,32),y+5,2)
pset(x+1,y+2,3)
pset(x+1,y+5,3)
pset(x+33,y+2,3)
pset(x+33,y+5,3)
...
pset(tx+i%3*2,ty+i\3*2-1+1-1-1+1,spot==i+1 and 4 or 2)
end
if i ~=1 then
end
end
print(name,x+2,y-5+1+1+1-2,2,-1)
print(c_major_names_short[major].."  "..f_prefix_zero(hp,3),x+1+1,y+8-1+1-1-1+1,2,-1)
f_draw_pkmn(num,px,py,16,flip,false,false,is_notactive,true)
end
add(op,{draw=function()
b(p_2.active,p_2.team,-1+1,4-1+2,39-4+2+1,1,true)
b(p_1.active,p_1.team,23+1-1,4+20+2+1-1-1,3+4-2-1,1-4+20+1+1+1)
end})
...
return f_zobj("active,@,team,@,name,@,subname,@,iscpu,@,turnover,~c_no,actions,#,greed,7",active,team,name,subname,iscpu)
end,function(player)
...
end,function(_ENV)add(op,{})end,function(_ENV)f_op_template_edit(op,c_items,"item")end,function(_ENV)f_add_stat(op,c_pokemon[f_getsel"g_grid_browse"])end,function(_ENV)
for i=0,251 do
...
f_zobj_set(_g,"f_op_movesel,@,f_op_batswitch,@,f_op_batresults,@,f_op_batstats,@,f_dt_editteam,@,f_dt_editstat,@,f_dt_editmove_template,@,f_dt_editmove,@,f_dt_browse,@,f_dt_editpkmn,@,f_dt_edit,@,f_dt_league,@,f_dt_batstats,@,f_dt_switch,@,f_dt_versus,@,f_dt_title,@,f_s_batresults,@,f_l_browse,@,f_s_browse,@,f_s_versus,@,f_s_league,@,f_s_batstat,@,f_s_edit,@,f_s_editteam,@,f_s_editstat,@,f_s_editmovebot,@,f_s_battle,@,f_s_title,@,f_s_pkstat,@,f_s_statedit,@,f_s_statbat,@,f_s_versusbegin,@,f_s_batbegin,@,f_s_editpkmn,@,f_s_editmove,@,f_s_edititem,@,f_l_title,@,f_l_battle,@,f_s_batmove,@,f_op_startturn,@,f_s_startturn,@,f_op_bataction,@,f_s_bataction,@,f_l_bataction,@,f_strtoq,@,f_loop_through_team_pkmn,@,_update,@,_draw,@",function(_ENV)
for i=1,4 do
...
print("\^w\^tpicodex",2,1-1+1+2-2,4)
print(c_palette_names[g_palette],2,13-5+3+1,2)
