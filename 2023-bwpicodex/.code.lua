...
f_zobj_set(_ENV,"c_yes,@,c_no,@,f_nop,@,f_zobj_setmeta,@,f_zobj,@,f_zcall,@,c_pokemon,#,c_moves,#,c_trainers,#,c_items,#,g_gridstack,#,g_palette,0,g_preview_timer,0,g_title_timer,0,g_shake_timer,0,g_title_l,253,g_title_r,254,g_msg_top, ,g_msg_bot, ,g_init_peek_loc,0x1fff;g_draw_masks;,8,4,2,1;g_style_size;,3,8,8",true,false,function()end,
function(parent,...)
...
f_zobj_set(_ENV,"f_refresh_top,@,f_add_to_ui_stack,@,f_pop_ui_stack,@,f_getsel,@,f_setsel,@,f_create_gridpair,@,f_update_grid,@,f_draw_grid,@,f_minisfx,@,f_flr_rnd,@,f_join,@,f_in_split,@,f_draw_pkmn,@,f_strtoq,@,f_init_peek_inc,@,f_unlock,@,f_update_locks,@,f_zcamera,@,f_hurt_self,@,f_moveutil_hpchange,@,f_moveutil_dmgself,@,f_moveutil_dmgother,@,f_moveutil_movemod,@,f_moveutil_typeadv,@,f_moveutil_calc_move_damage,@,f_movehelp_effect_works,@,f_move_major_other,@,f_move_splash,@,f_move_recover,@,f_move_weather,@,f_move_switch,@,f_move_default,@,f_movehelp_minor,@,f_move_confuse,@,f_move_seismictoss,@,f_move_psywave,@,f_move_superfang,@,f_move_falseswipe,@,f_move_submission,@,f_move_struggle,@,f_move_multihit_set,@,f_move_barrage,@,f_move_doublekick,@,f_move_flail,@,f_move_return,@,f_move_frustration,@,f_move_present,@,f_move_magnitude,@,f_move_hiddenpower,@,f_move_stat,@,f_create_spot,@,f_get_edit_op_pkmn,@,f_info_toggle,@,f_leagueinfo,@,f_add_stat_move,@,f_add_stat_preview,@,f_add_stat,@,f_print_info,@,f_addop_draw,@,f_addop_text,@,f_get_move_texts,@,f_prefix_space,@,f_prefix_zero,@,f_add_battle,@,f_create_player,@,f_get_other_pl,@,f_set_both_players,@,f_get_live_pkmn,@,f_get_next_active,@,f_end_battle,@,f_newaction,@,f_addaction,@,f_turn_addattack,@,f_pkmn_comes_out,@,f_pop_next_action,@,f_set_player_priority,@,f_decrement_timer,@,f_premovelogic,@,f_movelogic,@,f_start_turn,@,f_start_battle,@,f_switch_pkmn,@,f_switch_list,@,f_create_active,@,f_mkpkmn,@,f_team_party,@,f_fill_team,@,f_team_league,@,f_get_party_pkmn,@,f_save_party_pkmn,@,f_stat_crit,@,f_stat_evac,@,f_stat_calc,@,f_init_batresults,@,f_op_pickedit,@,f_op_pickleagueenemy,@,f_op_pickleagueplayr,@,f_op_pickversus,@,f_op_def,@,f_op_edititem,@",function()
...
end,function(n)return flr(rnd(n))end,function(...)
local text=""
for x in all{...}do
text..=x
end
return text
end,function(val,str)
...
if advantage>0 then
f_zcall(";,~f_turn_addattack,~p_action_self,@;;,~f_turn_addattack,~p_action_self,@",advantage>1 and "super effect"or advantage<1 and "little effect",crit and "critical hit")
...
end,function()f_turn_addattack(p_action_self,"does nothing")end,function(_ENV)return f_moveutil_hpchange(p_action_self,-p_action_self_active.maxhp\2)end,function(_ENV,weather)
f_addaction(p_turn_self,3,p_turn_self,"takes effect",function()
g_battle_weather.kind=weather
g_battle_weather.turn=5
g_battle_weather.player=p_turn_self
end,1)
end,function(_ENV,isself)
local pl=isself and p_turn_self or p_turn_other
local l=f_switch_list(pl)
if #l==0 then return true end
f_switch_pkmn(pl,3,l[f_flr_rnd(#l)+1])
...
f_zcall("op,@;;,~f_addop_text,~op,~c_yes,move,@, ,@;;,~f_addop_text,~op,~c_no,@, ,@;;,~f_addop_text,~op,~c_no,   pp ,@,/,@;;,~f_addop_text,~op,~c_no,pw/ac ,@,/,@",op
,ind,name
,method,typ
,pp,maxpp
,pow,accuracy
...
return function()
f_draw_pkmn(pkmn.num,21,off-12,3,p_battle_top and player==p_battle_top,true,false)
end
end
f_zcall("op,@;;,~f_addop_text,~op,~c_yes,@,@, ,@;;,~f_addop_draw,~op,@;;,~f_addop_draw,~op,@;;,~f_addop_draw,~op,@",op
...
f_zcall("op,@;;,~f_addop_text,~op,~c_yes,peek ,@;;,~f_addop_text,~op,~c_no,@;;,~f_addop_text,~op,~c_no,   hp ,@,/,@;;,~f_addop_text,~op,~c_no, item ,@;;,~f_addop_text,~op,~c_yes,info ,@;;,~f_addop_text,~op,~c_no,gendr ,@;;,~f_addop_text,~op,~c_no,type1 ,@;;,~f_addop_text,~op,~c_no,type2 ,@;;,~f_addop_text,~op,~c_yes,stat ,@;;,~f_addop_text,~op,~c_no,at/df ,@,/,@;;,~f_addop_text,~op,~c_no,sa/sd ,@,/,@;;,~f_addop_text,~op,~c_no,sp/lv ,@,/050",op
,pkmn.name
,"major "..c_major_names_long[pkmn.major]or "prevo "..c_pkmn_names[pkmn.prevolve]
,f_prefix_zero(pkmn.hp,3),f_prefix_zero(pkmn.maxhp,3)
,c_item_names[pkmn.item]
,pkmn.name
,c_gender_names[pkmn.gender]
,c_type_names[pkmn.pktype1]
,c_type_names[pkmn.pktype2]
,pkmn.name
...
if player then
f_zcall("op,@,pkmn,@;;,~f_add_stat_move,~op,~pkmn,0;;,~f_add_stat_move,~op,~pkmn,1;;,~f_add_stat_move,~op,~pkmn,2;;,~f_add_stat_move,~op,~pkmn,3",op,pkmn)
end
end,function(op,...)
local params={...}
f_addop_draw(op,function()
local infoobj=f_zobj(unpack(params))
print(f_join(unpack(infoobj[1])),1,1,3)
print(f_join(unpack(infoobj[2])),1,8,1)
end)
end,function(op,draw,disabled)
add(op,{draw=draw,disabled=disabled})
end,function(op,disabled,...)
...
f_draw_pkmn(active.invisible and num or active.num,px,py,3,flip,p_action_self==_ENV,false,active.invisible and f_nop or function()
print(active.name,1,0,1,-1)
if active.hp>0 then
f_zcall(";,~rectfill,0,6,@,9,1;;,~pset,0,6,2;;,~pset,0,9,2;;,~pset,32,6,2;;,~pset,32,9,2",mid(0,active.hp/active.maxhp*32,32))
end
local tx,ty=14,13
for i=0,5 do
if active.spot==i+1 or team[i+1].valid and team[i+1].major ~=1 then
pset(tx+i%3*2,ty+i\3*2-1,active.spot==i+1 and 3 or 1)
end
end
print(c_major_names_short[active.major].."  "..f_prefix_zero(active.hp,3),1,11,1,-1)
end)
end})
end
f_zcall("b,@;;,~b,~p_battle_top,39,1,~c_yes;;,~b,~p_battle_bot,3,1",b)
...
f_zcall";,~f_pop_ui_stack;;,~f_pop_ui_stack;;,~f_pop_ui_stack"
f_add_to_ui_stack(g_grid_battle_results)
end,function(level,player,message,logic,message_type)
...
elseif movenum==230 and not p_action_other.nextmove then priority_class=7000
...
f_moveutil_dmgself(f_moveutil_calc_move_damage(c_moves[252],p_turn_self_active,p_turn_self_active))
...
f_addaction(p_battle_bot,1,p_battle_bot,not p_battle_bot.iscpu and "begins turn",x,0)
f_addaction(p_battle_top,1,p_battle_top,not p_battle_top.iscpu and "begins turn",x,0)
...
f_addaction(p_first,6,p_first,false,function()
if g_battle_weather.turn>0 then
if g_battle_weather.kind==3 then
for pl in all{p_first,p_last}do
if not f_in_split(pl.active.pktype1,"13,7,17 ")and not f_in_split(pl.active.pktype2,"13,7,17 ")then
f_addaction(pl,3,pl,"hurt by sand",function()
f_moveutil_dmgself(ceil(p_turn_self_active.maxhp/8))
end)
end
end
end
...
f_addaction(g_battle_weather.player,6,g_battle_weather.player,"goes away",f_nop,1)
end)
end)
end)
...
f_s_bataction()
end,function(pl,level,nextpkmn)
...
if pkmn.valid and i ~=pl.active.spot and pkmn.major ~=1 then
add(l,i)
end
end
return l
...
f_zobj_set(_ENV,"f_op_statbrowse,@,f_op_browse,@,f_op_statbattle,@,f_add_edit,@,f_op_editteam,@,f_op_title,@,f_op_editmovebot,@,f_op_editstat,@,f_op_editmove,@,f_op_batsel,@,f_op_movesel,@,f_op_dmovsel,@,f_op_batswitch,@,f_op_batresults,@,f_op_batstats,@,f_add_browse_info_template,@,f_add_browse_info,@,f_add_editbrowse_info,@,f_dt_batstats,@,f_s_batresults,@,f_l_browse,@,f_s_browse,@,f_s_versus,@,f_s_league,@,f_s_batstat,@,f_s_edit,@,f_s_editteam,@,f_s_editstat,@,f_s_editmovebot,@,f_s_battle,@,f_s_title,@,f_s_pkstat,@,f_s_statedit,@,f_s_statbat,@,f_s_versusbegin,@,f_s_batbegin,@,f_s_editpkmn,@,f_s_editmove,@,f_s_edititem,@,f_l_title,@,f_l_battle,@,f_s_batmove,@,f_s_dmovsel,@,f_s_batswitch,@,f_op_bataction,@,f_s_bataction,@,_update,@,_draw,@,c_move_names,@,c_trnr_names,@,c_type_names,@,c_item_names,@,c_team_names,@,c_stages,@,c_pkmn_names,@,c_gender_names,@,c_major_names_long,@,c_major_names_short,@,c_movemethod_names,@,c_statmod_names,@,c_weather_names,@,c_palettes,@,c_palette_names,@,c_types,@,c_move_funcs,@",function(_ENV)
...
f_draw_pkmn(c_pokemon[i].lock and i or 252,1,1,1,false,is_sel,gridobj.disabled)
end})
end
end,function(_ENV)
...
f_draw_pkmn(ind,(ii-1)%3+1+(ii-1)%3*9,1+(ii-1)\3*10,1,false,is_sel,gridobj.disabled)
end
end})
end
end,function(_ENV)
...
f_draw_pkmn(pkmn.num,1,1,2,false,is_sel,false)
end})
end
end,function(_ENV)
...
f_draw_pkmn(g_title_l,7-4,21,3,false,g_title_sel,false,function()
print(messages[g_title_l%#messages+1],3,-1)
end)
f_draw_pkmn(g_title_r,39,1,3,true,not g_title_sel,false,function()
print(messages[g_title_r%#messages+1],0,0)
end)
end})
f_zcall("op,@;;,~f_addop_text,~op,~c_no,view;;,~f_addop_text,~op,~c_no,edit;;,~f_addop_text,~op,~c_no,league;;,~f_addop_text,~op,~c_no,versus",op)
end,function(_ENV)
local pkmn=f_get_party_pkmn(f_getsel"g_grid_pickedit",f_getsel"g_grid_pickspot")
for i=1,4 do
...
f_draw_pkmn(pkmn.num,1,1,2,p_action_self==p_battle_top,is_sel,disabled)
end})
end
end,function(_ENV)
for i=1,6 do
...
add(op,{disabled=disabled,draw=function(i,is_sel)
f_draw_pkmn(pkmn.num,1,1,3,p_action_other==p_battle_top,is_sel,disabled)
end})
end
...
f_switch_pkmn(p_action_self,4,f_getsel"g_grid_battle_switch"+1)
f_pop_ui_stack()
f_pop_ui_stack()
f_add_to_ui_stack(g_grid_battle_actions)
end,function(_ENV)
...
if p_curaction.message_type==0 then
g_msg_top=p_action_self.name.." "..p_action_self.subname
elseif p_curaction.message_type==1 then
