...
end,function()f_turn_addattack(p_action_self,"does nothing")end,function(_ENV)return f_moveutil_hpchange(p_action_self,-p_action_self_active.maxhp\2)end,function(_ENV,isself)
