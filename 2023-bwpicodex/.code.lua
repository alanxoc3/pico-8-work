...
local pkmn=f_get_party_pkmn(@0x5ec8,@0x5ece)
if@0x5ed0<4 then
print("\f4#"..(@0x5ed2+1).." \f4"..pkmn.possible_moves_method[pkmn.possible_moves[@0x5ed2+1]],1,1)
end
end,function(i,is_sel)
print("\f4hello",1,1)
end,function(i,is_sel,gridobj)
