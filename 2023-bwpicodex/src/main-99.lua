...
f_zcall(f_create_gridpair, [[
  ...
  if i == 1 then
    ...
    pset(1-32, -1, C_0)
    pset(28, -1, C_0)
    print("\f1"..c_pkmn_names[pkmn_ind+1].." sTATS", 1-30, 1)
  elseif i == 11 then
    rectfill(1-32, -1, 28, 7, C_2)
    print("\f1"..c_pkmn_names[pkmn_ind+1].." mOVES", 1-30, 1)

  elseif i > 11 then
    print(c_move_names[i-11], 1, 1, C_0)
