...
;;,f_move_damage       ,0  -- M_MEGAPUNCH
;;,f_move_seismictoss  ,999 -- M_SEISMICTOSS
;;,f_move_splash       ,0  -- M_SUBMISSION
;;,f_move_damage       ,0  -- M_MEGAKICK
...
;;,f_move_damage       ,0  -- M_WINGATTACK
;;,f_move_damage       ,0  -- M_PECK
