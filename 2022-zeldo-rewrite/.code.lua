...
zclass[[explode,actor,drawlayer_50|x,@,y,@,len,@,mod,@,draw,%explode_draw;start;duration,.25;]]
...
zclass[[arrow,vec,actor,drawlayer_50|x,@,y,@,dx,@,destroyed,%arrow_destroyed,draw,%arrow_draw;start;duration,.5;]]
