...
item:kill()
elseif not a:is_active"stunned_cooldown"and not a:is_active"stunned"and not a.is_energy_cooling_down and item.is_default and btn"4"then
...
if not btn"5"and not a:is_active"stunned"then
