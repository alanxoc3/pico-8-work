...
zclass[[rstat|buffer;,;update,%rstat_update,set,%rstat_set]]
...
zclass[[sign,target_with_tbox,solid,simple_spr,drawlayer_50|text,,rx,.375,ry,.375,sy,-2,cname,sign,cspr,24,sind,24,trx,.125,try,.375,tx,0,ty,.25]]
