zclass[[spike,enemy,simple_spr,actor,drawlayer_25|
    ...
    up;      next,middle2, sind,54, pl_collide_func,%f_spike_pl_collide_func, duration,.25;
    middle2; next,down,    sind,53, duration,.05;
]]

|[f_spike_pl_collide_func]| function(a, pl)
    pl:hurt(1)
end $$
...
zclass[[blockade,simple_spr,actor,drawlayer_25|
    ...
    close;  next,closed, sind,26, init,%f_blockade_close_init, duration,.05;
    closed; next,open,   sind,25;
    open;   next,opened, sind,26, init,%f_blockade_open_init,  duration,.05;
    opened; next,close,  sind,27;
]]

|[f_blockade_close_init]| function(a)
    if a.wall then deregister_entity(a.wall) a.wall = nil end
end $$

|[f_blockade_open_init]| function(a)
...
zclass[[saveplat,ma_interact,box,simple_spr,actor,drawlayer_25|
    ...
    update,%f_saveplat_update;
]]

|[f_saveplat_update]| function(a)
