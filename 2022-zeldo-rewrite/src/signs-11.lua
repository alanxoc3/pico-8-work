...
-- if the actor supports it and in f_interact mode, 
...
zclass[[class_with_target,actor|
    ...
    init,%f_class_with_target_init,
    callback_touch,nop,
    callback_outside,nop
]]

|[f_class_with_target_init]| function(a)
...
zclass[[target_with_tbox,class_with_target,ma_interact|
    ...
    gettext,%f_target_with_tbox_gettext,
    callback_touch,%f_target_with_tbox_target_func,
    target_with_tbox_disable_callback,nop,
    target_with_tbox_finish_callback,nop
]]

|[f_target_with_tbox_gettext]| function(a)
    return a.text, function()
        a:target_with_tbox_finish_callback()
    end
end $$

|[f_target_with_tbox_target_func]| function(a)
...
|[f_sign_target_with_tbox_disable_callback]| function()
