zclass[[person,actor,solid,target_with_tbox,simple_spr,drawlayer_50|
    ...
    rx,.375, ry,.375,
    trx,.5, try,.5,
    target_with_tbox_disable_callback,%f_person_target_with_tbox_disable_callback
]]

|[f_person_target_with_tbox_disable_callback]| function(a)
    a.xf = sgn(g_pl.x-a.x)
    return _g.f_sign_target_with_tbox_disable_callback()
end $$

|[f_person_target_with_tbox_finish_callback]| function(a)
...
zclass[[navyblock,person|
    ...
    target_with_tbox_finish_callback,%f_person_target_with_tbox_finish_callback
|MEM_IS_NAVY_HOME|0
]]
...
zclass[[limeboss,person|
    ...
    rx,.375, ry,.375,
    target_with_tbox_finish_callback,%f_lime_callback
|MEM_IS_SLOBS_DEAD|0
]]
...
zclass[[limebeat,person|
    ...
    target_with_tbox_disable_callback,%f_sign_target_with_tbox_disable_callback,
...
zclass[[limestatue,actor,simple_spr,drawlayer_50|
    ...
    sind,SPR_LIME, sy,-2,
    shaking,yes,
    destroyed,%f_limestatue_destroyed;

    start; duration,.5;
]]

|[f_limestatue_destroyed]| function(a)
    music'21'
    _g.slobs(a.x, a.y)
end $$
...
zclass[[teach,person|
    ...
    gettext,%f_teach_gettext
]]

|[f_teach_gettext]| function(a)
...
zclass[[keep_parent,person|
    ...
    gettext,%f_keep_gettext
]]

|[f_keep_gettext]| function(a)
