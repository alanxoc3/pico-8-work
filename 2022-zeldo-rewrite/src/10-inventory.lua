zclass[[inventory,actor,vec,drawlayer_99|
    ind,5, x,64, y,-2, draw,%inventory_draw;
    ...
    ITEM_IND_BANJO;    mem_loc,MEM_HAS_BANJO  , sxo,0, x,-21,    y,5,   w,4.5, sind,SPR_BANJO;
    ITEM_IND_BOMB;     mem_loc,MEM_HAS_BOMB   , sxo,0, x,-21  ,  y,-5,  w,4.5, sind,SPR_BOMB;
    ITEM_IND_BOW;      mem_loc,MEM_HAS_BOW    , sxo,0, x,-11 ,   y,5,   w,4.5, sind,SPR_BOW;
    ITEM_IND_SWORD;    mem_loc,MEM_HAS_SWORD  , sxo,0, x,-11,    y,-5,  w,4.5, sind,SPR_SWORD;
    ITEM_IND_INTERACT; mem_loc,MEM_ALWAYS_TRUE, sxo,2, x,0  ,    y,0,   w,6,   sind,SPR_INTERACT;
    ITEM_IND_SHIELD;   mem_loc,MEM_HAS_SHIELD , sxo,0, x,12 ,    y,-5,  w,4.5, sind,SPR_SHIELD;
    ITEM_IND_BRANG;    mem_loc,MEM_HAS_BRANG  , sxo,0, x,12,     y,5,   w,4.5, sind,SPR_BRANG;
    ITEM_IND_MASK;     mem_loc,MEM_HAS_MASK   , sxo,0, x,22  ,   y,-5,  w,4.5, sind,SPR_MASK;
    ITEM_IND_BOWL;     mem_loc,MEM_HAS_BOWL   , sxo,0, x,22 ,    y,5,   w,4.5, sind,SPR_BOWL;
]]
