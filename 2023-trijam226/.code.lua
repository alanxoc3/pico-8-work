...
create_parent([[133|134]],function(a,other)
if other.portal and not a.teleporting then
end
end)
create_actor([[135|136]],function(a)
...
create_actor([[137|136]],function(a)
...
create_actor([[138|136]],function(a)
control_player(a,xbtn(),ybtn(),btn(4),btn(5),_g.good_fist)
end,function(a)
a:create_dead_body()
g_endgame_stats.deaths=g_endgame_stats.deaths+1
...
local dungeon_and_hospital=tabcpy(ztable[[141]])
return{
dungeon=dungeon_and_hospital,
hospital=dungeon_and_hospital,
bossroom=tabcpy(ztable[[142]])
}
end
