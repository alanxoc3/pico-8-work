...
-- this function goes in your game.
function gen_cipher()
...
-- this does not need to be embedded in your game.
...
-- this function uncompresses the image for your game and store it in memory.
function img_x(str)
	local ret = ""
	local rep = false
	local cnt = 0
...
-- embed this function in your game
-- this function draws an uncompressed image.
