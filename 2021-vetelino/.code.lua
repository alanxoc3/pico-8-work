...
zclip(x1,y1,x2,y2)
zcls(g_cur_room.c)
batch_call_new(acts_loop,[[89]])
isorty(g_act_arrs.drawable)
batch_call_new(acts_loop,[[90]])
clip()
camera()
end
end