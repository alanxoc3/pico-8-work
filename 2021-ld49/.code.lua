...
local dungeon_and_hospital=ztable[[124]]
return{
...
batch_call_new(acts_loop,[[130]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[135]],logo_draw,function()end,
