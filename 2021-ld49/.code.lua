...
create_parent([[116|25]],function(a,other)
...
create_actor([[119|118]],function(a)
control_player(a,xbtn(),ybtn(),btn(4),btn(5))
end,function(a)
a:create_dead_body()
_g.fader_out(1,nf,g_reset_room)
end)
create_actor([[120|118]],function(a)
...
batch_call_new(acts_loop,[[126]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[131]],logo_draw,function()end,
