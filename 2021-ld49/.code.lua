...
create_actor([[108|105]],function(a)
control_player(a,xbtn(),ybtn(),btn(4),btn(5),true)
end)
create_actor([[109|105]],function(a)
...
batch_call_new(acts_loop,[[112]],g_act_arrs["col"],g_act_arrs["pl"],g_act_arrs["fist"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[117]],logo_draw,function()end,
