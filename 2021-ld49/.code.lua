...
batch_call_new(acts_loop,[[121]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[126]],logo_draw,function()end,
