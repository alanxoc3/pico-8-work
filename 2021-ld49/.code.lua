...
create_parent[[53|43]]
create_parent[[54|55]]
create_parent([[56|57]],scr_spr)
create_parent([[58|59]],function(a,direction)
...
create_parent([[60|61]],function(a,damage)
damage=damage or 1
...
create_parent[[62|63]]
create_parent([[64|65]],function(a,acts)
local hit_list={}
...
hit_list[b]=hit_list[b]or ztable[[66]]
batch_call_new(col_help,[[67]],a,b,x,dx,y,dy)
end
end
end)
return ret_val
...
create_parent([[68|69]],function(a,solid_func)
...
create_actor[[89|90]]
create_actor[[91|92]]
create_parent([[93|94]],function(a)
for i=1,a.rate do
...
create_parent([[101|102]],function(a)
a.rel_dx=cos(a.rel_actor.dir)*.03
a.rel_dy=sin(a.rel_actor.dir)*.03
end)
create_actor[[103|104]]
create_actor[[105|104]]
create_parent([[106|107]],function(a)
...
create_parent([[128|129]],function(a,other)
...
create_actor([[132|131]],function(a)
...
create_actor([[133|131]],function(a)
...
local dungeon_and_hospital=tabcpy(ztable[[136]])
return{
dungeon=dungeon_and_hospital,
hospital=dungeon_and_hospital,
bossroom=tabcpy(ztable[[137]])
}
end
...
batch_call_new(acts_loop,[[143]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(a,x,y)
...
music(0,3000)
sfx(63)
g_tl=ztable([[147]],logo_draw,function()end,
