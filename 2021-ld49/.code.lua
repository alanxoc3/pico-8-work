...
create_parent[[52|42]]
create_parent[[53|54]]
create_parent([[55|56]],scr_spr)
create_parent([[57|58]],function(a,direction)
...
create_parent([[59|60]],function(a,damage)
damage=damage or 1
...
create_parent([[107|108]],function(a,other)
if not a:any_timer_active"roll"then
...
create_parent([[119|120]],function(a,other)
...
create_actor([[123|122]],function(a)
...
create_actor([[124|122]],function(a)
...
local dungeon_and_hospital=ztable[[127]]
return{
...
batch_call_new(acts_loop,[[133]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[138]],logo_draw,function()end,
