...
create_actor([[118|102]],function(a)
a.xf=a.x-g_pl.x>0
if t()%5<.5 then
a.ixx=flr_rnd(3)-1
a.sind=rnd_item{41,42,43}
...
create_parent([[129|130]],function(a,other)
...
create_actor([[133|132]],function(a)
...
create_actor([[134|132]],function(a)
...
local dungeon_and_hospital=ztable[[137]]
return{
...
function _init()
music(0)
g_tl=ztable([[148]],logo_draw,function()end,
