...
return{
dungeon=ztable[[124]],bossroom=ztable[[125]]
}
end
...
batch_call_new(acts_loop,[[129]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[134]],logo_draw,function()end,
