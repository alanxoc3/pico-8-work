...
batch_call_new(acts_loop,[[108]],g_act_arrs["col"],g_act_arrs["pl"],g_act_arrs["fist"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[113]],logo_draw,function()end,
