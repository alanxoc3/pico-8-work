...
batch_call_new(acts_loop,[[85]],g_act_arrs["col"],g_act_arrs["pl"],g_act_arrs["fist"])
...
map(0,0,0,0,15,12)
rect(0,2,10,10,7,8)
batch_call_new(acts_loop,[[86]])
isorty(g_act_arrs.drawable)
batch_call_new(acts_loop,[[87]])
...
function _init()
music(0,3000)
g_tl=ztable([[88]],logo_draw,function()sfx"63" end,
