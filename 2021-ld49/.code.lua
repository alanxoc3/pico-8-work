...
create_actor([[116|100]],function(a)
a.xf=a.x-g_pl.x>0
if t()%5<.5 then
a.ixx=flr_rnd(3)-1
a.sind=rnd_item{41,42,43}
...
create_parent([[127|128]],function(a,other)
...
create_actor([[131|130]],function(a)
...
create_actor([[132|130]],function(a)
...
local dungeon_and_hospital=ztable[[135]]
return{
...
batch_call_new(acts_loop,[[141]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[146]],logo_draw,function()end,
