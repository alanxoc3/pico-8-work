...
create_parent([[121|122]],function(a,other)
...
create_actor([[125|124]],function(a)
...
create_actor([[126|124]],function(a)
...
local dungeon_and_hospital=ztable[[129]]
return{
...
batch_call_new(acts_loop,[[135]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[140]],logo_draw,function()end,
