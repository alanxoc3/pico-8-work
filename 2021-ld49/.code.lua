...
create_actor[[106|105]]
create_parent([[107|108]],function(a)
...
create_parent([[109|110]],function(a,other)
...
create_parent([[111|112]],function(a,other)
if not a:any_timer_active"roll"then
...
create_actor([[117|101]],function(a)
a.xf=a.x-g_pl.x>0
if t()%5<.5 then
a.ixx=flr_rnd(3)-1
a.sind=rnd_item{41,42,43}
...
batch_call_new(acts_loop,[[142]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
