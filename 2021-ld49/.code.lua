...
create_parent([[116|117]],function(a,other)
...
create_actor([[120|119]],function(a)
control_player(a,xbtn(),ybtn(),btn(4),btn(5))
end,function(a)
a:create_dead_body()
_g.fader_out(1,nf,g_reset_room)
end)
create_actor([[121|119]],function(a)
...
batch_call_new(acts_loop,[[127]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
...
batch_call_new(acts_loop,[[129]])
if g_debug then acts_loop("dim","debug_rect")end
camera()
clip()
batch_call_new(acts_loop,[[130]])
tbox_draw(16,48)
if g_debug then
...
function _init()
music(0)
g_tl=ztable([[132]],logo_draw,function()end,
