...
create_actor[[106|107]]
create_actor[[108|107]]
create_parent([[109|110]],function(a)
...
create_parent([[113|114]],function(a,other)
if not a:any_timer_active"roll"then
...
create_parent([[125|126]],function(a,other)
...
create_actor([[129|128]],function(a)
...
create_actor([[130|128]],function(a)
...
local dungeon_and_hospital=ztable[[133]]
return{
...
batch_call_new(acts_loop,[[139]],g_act_arrs["wall"],g_act_arrs["bad_character"],g_act_arrs["good_character"],g_act_arrs["portal"],function(x,y)
...
function _init()
music(0)
g_tl=ztable([[144]],logo_draw,function()end,
