...
create_parent([[32|31]],function(a)
...
create_parent[[54|46]]
create_parent[[55|46]]
create_parent([[56|57]],scr_spr,scr_out,scr_spr_and_out
)
create_parent([[58|59]],scr_spr_and_out)
create_parent([[60|61]],function(a,speed,xdir,ydir)
a.dx=xdir*speed
a.dy=ydir*speed
end)
create_parent([[62|63]],function(a)
...
create_parent([[64|65]],function(a,damage,stun_val)
if a.stun_countdown<=0 then
...
create_parent[[66|20]]
create_parent([[67|68]],function(a)
if a.anim_sind then
a.sind=a.anim_sind
else
...
create_parent([[69|70]],function(a,b)
...
create_parent[[71|72]]
create_parent([[73|74]],function(a,acts)
local hit_list={}
...
hit_list[b]=hit_list[b]or ztable[[75]]
batch_call_new(col_help,[[76]],a,b,x,dx,y,dy)
end
end
end)
return ret_val
...
create_parent([[77|78]],function(a,solid_func)
...
create_parent([[91|92]],function(a)
...
batch_call_new(update_view_helper,[[97]],a)
end,function(a)
...
g_pl=_g.pl(3,3)
g_cur_room=tabcpy(ztable[[99]])
end
function game_update(a)
batch_call_new(
acts_loop,[[100]],g_act_arrs["col"],
function(x,y)
