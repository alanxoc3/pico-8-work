...
elseif a.tl_tim<11*wait then a.txt="i also forgot to mention"
elseif a.tl_tim<12*wait then a.txt="this game isn't finished"
elseif a.tl_tim<13*wait then a.txt="so... you win!"
...
elseif a.tl_tim<29*wait then a.txt="for the credits"
elseif a.tl_tim<30*wait then a.txt="@alanxoc3 = code & sfx"
elseif a.tl_tim<31*wait then a.txt="@cadetthegreat = gfx"
elseif a.tl_tim<32*wait then a.txt="that's it for real"
elseif a.tl_tim<33*wait then a.txt="bye bye kitty"
elseif a.tl_tim<34*wait then a.txt=""
end
end)
