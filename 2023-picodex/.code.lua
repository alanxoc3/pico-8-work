...
return zobj([[edraw,@,v,0,r,@,w,@,h,@,x,@,y,@,update,%mevu_view_update,draw1,%menu_draw1,cancel,%menu_cancel,refresh,%menu_refresh]],edraw,r or 1,w or 40,h or 40,x or 0,y or 0)
end
function create_menu(...)
return zobj_set(create_menu_view(...),[[c,0,update,%menu_update,set,%menu_set]])
end
