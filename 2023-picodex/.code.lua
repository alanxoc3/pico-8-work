...
newpkmn.maxhp=f_calc_max_stat(newpkmn.base_hp)+5+50
...
f_zcall(f_loop_entities,[[1;,actor,clean;2;,fader,clean;]])
f_register_entities()
f_zcall(f_loop_entities,[[1;,fader,tick;2;,game_state,tick;3;,fader,state;4;,game_state,state;]])
end
function _draw()
local _ENV=_g
_cls()
