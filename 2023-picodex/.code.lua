...
c_modes=zobj[[len,6;0;name,browse,state,browse;1;name,credits,state,credits;2;name,fight,state,fight;3;name,games,state,games;4;name,party,state,party;5;name,settings,state,settings;]]
