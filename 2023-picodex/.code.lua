...
end,function(game)f_print_draw3_message(_split(game:entry"main".desc,"|"))end,function(game)f_print_draw3_message(_split(game:entry"pselactions".desc,"|"))end,function(_ENV)f_fight_draw3_helper(p0.statplayer.active)end,function(_ENV)
...
stack={stack[1]}
menu:refresh{}
f_zobj_set(menu,[[v,0;;pkmn,@;;hidden,%c_yes;;name,@,style,5;;name,@;;name,@;;pkmn,@;;hidden,%c_yes;;name,@,style,5;;name,@;;name,@]],winner.active,winner.name,"3".." live",#winner.deadnums.." dead",
...
menu:refresh{}
f_zobj_set(menu,[[;pkmn,@;;hidden,%c_yes;;name,@,style,5;;name,3 live;;name,2 dead;;name,moves,style,5;;name,metrnome;;name,none;;name,thrash;;name,firespin;;name,modifier,style,5;;name,atk +1;;name,def -1;;name,state,style,5;;name,confused;;name,digging;;name,flying]],p0.statplayer.active,p0.statplayer.name)
end,function(game)
...
_ENV[dd.key]=f_zobj([[hordeind,6,deadnums,#,actions,#,priority,1,menu_action,@,menu_move,@,menu_stats,@,menu_switch,@,team,@,name,@,iscpu,@,dielogic,@,winlogic,@]],f_create_menu(f_menu_drawentry),
