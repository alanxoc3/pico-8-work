...
f_zobj_set(menu,[[;pkmn,@;;hidden,%c_yes;;name,@,style,5;;name,@;;name,@;;name,moves,style,5;;name,metrnome;;name,none;;name,thrash;;name,firespin;;name,modifier,style,5;;name,atk +1;;name,def -1;;name,state,style,5;;name,confused;;name,digging;;name,flying]],player.active,player.name,(#f_get_team_live(player.team,true)).." live",(#f_get_team_dead(player.team)).." dead")
end,function(game)
