...
|[f_editteam_draw2]|   function(game) f_print_draw2_message("spot #"..(game:cursor'editteam'+1)) end $$
|[f_teammoves_draw2]|  function(game) f_print_draw2_message("move #"..(game:cursor'teammoves'+1)) end $$
