c_pokemon = zobj[[
   ...
   ;;, 0,   "nidoran f",   T_POISON,   T_NONE,      55,  47,  52,  41,  40,  1,1,8,17,23,30,38,43            -- 29
   ...
   ;;, 0,   "nidoran m",   T_POISON,   T_NONE,      46,  57,  40,  50,  40,  1,1,8,17,23,30,38,43            -- 32
...
c_trainers = zobj[[
   ...
   ;;,"gentlman", P_GROWLITHE, P_NIDORANM,  P_DRATINI,   P_PONYTA,    P_PIKACHU,   P_EEVEE
   ;;,"sailor",   P_SHELLDER,  P_TENTACOOL, P_PSYDUCK,   P_POLIWAG,   P_KRABBY,    P_POLIWHIRL
   ;;,"rocker",   P_VOLTORB,   P_ZUBAT,     P_VENONAT,   P_ABRA,      P_MAGNEMITE, P_JOLTEON
   ...
   ;;,"blue",     P_PIDGEOT,   P_ALAKAZAM,  P_RHYDON,    P_ARCANINE,  P_EXEGGUTOR, P_BLASTOISE
