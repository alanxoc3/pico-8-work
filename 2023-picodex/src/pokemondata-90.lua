...
_g.c_moves_raw = f_zobj[[
  ...
  ;0;, "struggle", T_BIRD,     0,  50,  100,  %f_move_recoil                                                -- 0   DIFF: ignores resistance now. hits ghost pokemon.
   ...
   ;;, "rllngkck", T_FIGHTING, 15, 60,  85,   %f_move_default,30,%f_move_other,%f_movehelp_minor,flinching  -- 74
   ;;, "sandatck", T_GROUND,   15, 0,   100,  %f_move_other, %f_move_stat, accuracy, -1                     -- 75
   ;;, "headbutt", T_NORMAL,   15, 70,  100,  %f_move_default,30,%f_move_other,%f_movehelp_minor,flinching  -- 76
   ...
   ;;, "bite",     T_NORMAL,   25, 60,  100,  %f_move_default,10,%f_move_other,%f_movehelp_minor,flinching  -- 87
   ...
   ;;, "lowkick",  T_FIGHTING, 20, 50,  90,   %f_move_default,30,%f_move_other,%f_movehelp_minor,flinching  -- 103
   ...
   ;;, "hyprfang", T_NORMAL,   15, 80,  90,   %f_move_default,10,%f_move_other,%f_movehelp_minor,flinching  -- 160
